...
const helpData: HelpSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'latest', title: 'آخرین اخبار', icon: '📰', content: 'بخش آخرین اخبار صفحه اصلی فقط اخبار استان بوشهر را با تایید شما نمایش می‌دهد. از مدیریت صفحه اصلی > آخرین اخبار، با دکمه "ویرایش" برای هر باکس خبر انتخاب کنید، سپس با دکمه "تایید" آن را روی سایت منتشر کنید. خبرهای "در انتظار تایید" در سایت نمایش داده نمی‌شوند. با دکمه "لغو تایید" می‌توانید خبر را از سایت مخفی کنید.' },
      { id: 'latest-approve', title: 'تایید خبر آخرین اخبار', icon: '✅', content: 'هر باکس آخرین اخبار وضعیت دارد: "تایید شده" (سبز، نمایش در سایت) یا "در انتظار تایید" (نارنجی، مخفی از سایت). فقط باکس‌هایی که خبر انتخاب شده دارند دکمه "تایید" یا "لغو تایید" نشان می‌دهند. بدون تایید شما هیچ خبری در این بخش بارگذاری نمی‌شود. اگر خبر انتخابی بوشهری نباشد، نشان "غیربوشهر ـ نمایش داده نمی‌شود" می‌بینید و آن خبر در سایت نمایش داده نمی‌شود.' },
