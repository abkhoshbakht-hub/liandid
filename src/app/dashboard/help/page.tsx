...
const helpData: HelpSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'newspaper-tab', title: 'تب صفحه اول روزنامه‌ها', icon: '📰', content: 'در باکس «اخبار لحظه‌ای خبرگزاری‌ها» تب «صفحه اول روزنامه‌های کشور» اضافه شده که خبرهای روزنامه‌های همشهری و دنیای اقتصاد را نشان می‌دهد. این خبرها مثل بقیه با وضعیت «در انتظار تایید» می‌آیند و بعد از تایید شما نمایش داده می‌شوند.' },
