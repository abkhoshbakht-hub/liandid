...
const helpData: HelpSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'image-format', title: 'تبدیل فرمت عکس', icon: '🔄', content: 'هر عکسی با هر فرمتی آپلود شود، خودکار به فرمتی که در تنظیم عکس انتخاب کرده‌اید تبدیل می‌شود. JPEG سازگارترین، WebP کم‌حجم‌ترین گزینه است.' },
    ]
  },
  {
