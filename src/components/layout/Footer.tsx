    ...
    <footer className="bg-[#0f2440] mt-12 overflow-hidden">
      <div className="site-container py-5">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-5 mb-5">
          {/* ستون اول: لوگوی اعلام وصول و توضیحات */}
          <div className="text-center col-span-2 md:col-span-2 lg:col-span-1">
            <div className="w-[80px] h-[70px] mx-auto mb-2 bg-white rounded-lg p-1 flex items-center justify-center overflow-hidden">
              <div id="div_eRasanehTrustseal_96227" />
            </div>
          ...
          <div className="text-center md:text-right">
            <h3 className="text-[#C9A96E] font-black text-base mb-3">شبکه‌های اجتماعی</h3>
          ...
          <div className="text-center hidden md:block">
            <h3 className="text-[#C9A96E] font-black text-base mb-3">دسته‌بندی‌ها</h3>
          ...
          <div className="text-center">
            <h3 className="text-[#C9A96E] font-black text-base mb-3">لینک‌های مفید</h3>
          ...
          {/* ستون پنجم: خبرنامه */}
          <div className="text-center col-span-2 md:col-span-2 lg:col-span-1">
            <h3 className="text-[#C9A96E] font-black text-base mb-3">خبرنامه</h3>
            <p className="text-white/60 text-sm mb-2">آخرین اخبار را در ایمیل خود دریافت کنید</p>
            <NewsletterForm />
          </div>
        </div>
