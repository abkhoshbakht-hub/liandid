...
export default function SubmitBanner() {
  ...
  return (
    <div className="mt-12 bg-[#0a1628] rounded-xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
      ...
      <a
        href={link}
        className="flex items-center gap-2 bg-[#C9A96E] text-[#0a1628] px-6 py-3 rounded-lg font-bold text-sm hover:bg-[#d4b87a] transition-all flex-shrink-0 shadow-lg shadow-amber-900/20"
      >
